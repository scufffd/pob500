    ...
    <div style={{ fontFamily: "'Outfit',sans-serif", background: "#060A12", minHeight: "100vh", color: "#fff", opacity: on ? 1 : 0, transition: "opacity 0.5s", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 32px" }}>
          ...
          <div style={{ marginTop: 22, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            ...
            <span className="mono" style={{ fontSize: 10.5, color: "rgba(255,255,255,.13)" }}>Not financial advice</span>
          </div>
          </>)}
        </div>
      </div>
